...
<div class="container mx-auto px-4 py-8">
	<div class="mb-8 text-center">
		<h1 class="mb-4 text-4xl font-bold text-primary">Select Your Character</h1>
		<p class="text-lg text-base-content/70">
			Choose a character to continue your routing adventure
		</p>
	</div>
	...
	{#if $availableGameStates.length === 0}
		<div class="py-16 text-center">
			...
			<h2 class="mb-4 text-2xl font-bold">No Characters Yet</h2>
			<p class="mb-8 text-base-content/70">
				Create your first character to start playing the routing game!
			</p>
			<button class="btn btn-primary btn-lg" on:click={handleCreateModalOpen}>
	...
	{:else}
		...
		<div class="text-center">
			<button class="btn btn-outline btn-primary btn-lg" on:click={handleCreateModalOpen}>
...
{#if showCreateModal}
	<div class="modal modal-open">
		<div class="modal-box">
			<h3 class="mb-4 text-lg font-bold">Create New Character</h3>
			...
			<div class="modal-action">
				<button class="btn btn-ghost" on:click={handleCreateModalClose} disabled={isCreating}>
					Cancel
				</button>
				<button
