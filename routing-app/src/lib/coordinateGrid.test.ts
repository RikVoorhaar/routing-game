...
describe('ChunkGrid', () => {
    describe('constructor', () => {
        ...
        it('should throw error for invalid bounding box', () => {
            ...
            expect(() => new ChunkGrid(invalidBbox3, 0.1)).toThrow('Latitude must be between -90 and 90 degrees');

            const invalidBbox4 = { north: 55, south: 50, east: 185, west: 5 }; // lon > 180
            expect(() => new ChunkGrid(invalidBbox4, 0.1)).toThrow('Longitude must be between -180 and 180 degrees');
        });
    });
    ...
    describe('getChunk', () => {
        ...
        it('should throw error for points outside bounding box', () => {
            ...
            expect(() => grid.getChunk(52.10, 5.20)).toThrow('Longitude 5.2 is outside bounding box');
        });

        it('should return integer coordinates', () => {
            const grid = new ChunkGrid(utrechtBbox, 0.1);
            const chunk = grid.getChunk(52.10, 5.12);
    ...
    describe('different scales', () => {
        it('should work with various scales', () => {
            ...
            for (const scale of scales) {
                ...
                const testPoint = { lat: 52.10, lon: 5.12 };
