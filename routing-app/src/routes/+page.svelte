...
<svelte:head>
	...
	<meta
		name="description"
		content="Master the art of logistics and route optimization in the Routing Game"
	/>
</svelte:head>
			...
			<div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
				...
				<div class="space-y-8">
					<div class="text-center lg:text-left">
						<h1 class="mb-4 text-4xl font-bold text-primary">Build Your Logistics Empire</h1>
						<p class="text-xl text-base-content/70">
							Master the art of route optimization and grow your business
						</p>
					</div>
